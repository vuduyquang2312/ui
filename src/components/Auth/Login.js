...
export default function Login() {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-[#0f1233]">
      ...
      >
        <h2 className="text-white text-sm flex justify-center font-semibold mb-4">Đăng Nhập</h2>
        ...
        <div className="mb-4">
          ...
          <input
            ...
            className="w-full h-8 px-3 mt-2 outline-none text-xs text-white bg-[#0f1233] rounded-md focus:outline-none focus:border-blue-500"
            required
          />
        </div>
        ...
        <div className="mb-4">
          ...
          <input
            ...
            className="w-full h-8 mt-2 px-3 bg-[#0f1233] text-xs text-white rounded-md focus:outline-none focus:border-blue-500"
            required
          />
        </div>
        ...
        <p className="text-white text-xs flex justify-center mt-4">
          Chưa có tài khoản? <Link to="/auth/register" className="text-blue-500 ml-1">Đăng ký</Link>
        </p>
      </form>
    </div>
  );
